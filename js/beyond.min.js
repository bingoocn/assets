...
$(".show_resources>i").click(function(){
	return $('.right_resources,#frameMain').toggleClass('suo'),$(".show_resources>i").toggleClass("fa-step-backward  fa-step-forward"),$(".show_resources").toggleClass("suo"),!1
})
$(".show_tree>i").click(function(){
	return $('.mail-body,.mail-sidebar').toggleClass('suo'),$(".show_tree>i").toggleClass("fa-step-backward  fa-step-forward"),$(".show_tree").toggleClass("suo"),!1
})
InitiateSideMenu();
InitiateSettings();
InitiateWidgets();
